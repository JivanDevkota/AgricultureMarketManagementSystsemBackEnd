...
public class AdminOrderServiceImpl implements AdminOrderService{
    ...
    public List<OrderDTO>getAllPlacedOrder(){
        List<Order>orderList=orderRepository.findAllByOrderStatusIn(Arrays.asList(OrderStatus.Placed,OrderStatus.Shipped,OrderStatus.Delivered));
    ...
    public AnalyticsResponse calculateAnalytics(){
        ...
        Long previousMonthOrders=getTotalOrdersForMonth(previousMonthDate.getMonthValue(),
        ...
        Long previousMonthEarnings=getTotalEarningsForMonth(previousMonthDate.getMonthValue(),
                previousMonthDate.getYear());
